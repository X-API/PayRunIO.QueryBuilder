namespace PayRunIO.RqlAssistant.Service.Tests
{
    ...
    public class FailureLoggingTests
    {
        ...
        public void ValidationFailed_MessageCarriesTheFullFailureDetail()
        {
            ...
            var message = this.SingleEvent().RenderedMessage;

            // The whole point of the change: a reviewer must be able to see what was wrong, what the
            // query was and what was asked for, without pulling the structured fields up separately.
            ...
            Assert.That(message, Does.Contain("<Query><Entity /></Query>"));
        ...
        public void NoQueryProduced_RecordsThePromptAndTheReply()
        {
            ...
            Assert.That(Property(loggingEvent, "response"), Is.EqualTo("I can help with that. What period?"));
        ...
        public void AssistantResponse_RecordsTheReplyVerbatim()
        {
            ...
            // Verbatim: a reply whose prose and XML disagree is a distinct failure mode, and it is
            // only visible with the full text.
            Assert.That(Property(loggingEvent, "response"), Is.EqualTo(Response));
